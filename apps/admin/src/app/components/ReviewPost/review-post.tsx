...
export function Reviewpost ({ id }: { id: number }):JSX.Element {
  ...
  return (
    <div className="min-h-screen md:flex grid justify-around">
      ...
      <form
        onSubmit={onSubmit}
        className="p-10 m-10 grid border rounded-md w-[94vw] md:w-[40vw]"
      >
        ...
        <div className="flex justify-between">
          <button type="submit" className="btn mt-6 w-[25vw] md:w-[15vw]">
            save
          </button>
          <button
