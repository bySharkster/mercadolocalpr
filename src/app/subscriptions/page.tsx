            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
                ...
                <ul className="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <svg className="flex-shrink-0 size-5 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                    </div>
                    </li>
                ...
                <ul className="grid lg:grid-cols-6 lg:gap-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                        ...
                        <svg className="flex-shrink-0 size-5 text-gray-400 dark:text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/></svg>
                    </div>
                    </li>
                ...
                <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-1">
                    <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                        Get started
                    </a>
                    </div>
